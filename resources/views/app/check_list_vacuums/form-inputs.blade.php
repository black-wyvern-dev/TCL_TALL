                                    ...
                                    <div class="flex items-center" x-data="{ on: false }">
                                        <div class="toggle colour">
                                            <input
                                                ...
                                                {{$url_link ? 'disabled' : ''}}
                                            />
                                            <label for="engine_operation" class="toggle-label block w-12 h-6 rounded-full transition-color duration-150 ease-out"></label>
                                        </div>
                                        <span class="flex flex-col ml-3" id="availability-label" @click="on = !on; $refs.switch.focus()">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="grid grid-cols-6 gap-6 pb-6">
                    ...
                    <input  {{$url_link ? 'disabled' : ''}} name = "int_video" id = "int_video_form"  value = "{{ old('int_video', ($editing ? $checkListVacuum->int_video : '')) }}" hidden>

                    {{-- Column 2 33.3%--}}
                    <div class="col-span-6 sm:col-span-3"  style="height : 210px">
                        <video-tag id="external-video-tag"></video-tag>
                    </div>
                    <input {{$url_link ? 'disabled' : ''}} name = "ext_video" id = "ext_video_form" value = "{{ old('ext_video', ($editing ? $checkListVacuum->ext_video : '')) }}" hidden>
                    {{-- Column 4 100%--}}
                    <div class="col-span-6 sm:col-span-6">
                    ...
                    <div class="col-md-12 d-flex align-items-center justify-content-center">                        
                        <div class="mt-1 border border-gray-200">                                                        
                            <img id="cleaning_status_image" class="mx-auto"
                                src="{{old('cleaning_status', $editing ? ($checkListVacuum->cleaning_status && str_contains($checkListVacuum->cleaning_status, '/')) ? asset('storage/'.$checkListVacuum->cleaning_status) : '/img/tanker1.jpg' : '/img/tanker1.jpg')}}" alt="cleaning_status_image">                            
        ...
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="box-content rounded border-2 border-gray-300">
                    <a id = "left-side">
                        <img id="left-side-image" class="mx-auto" src="{{$editing ? $checkListVacuum->ext_splat_left : $hire->tanker->ext_splat_left}}" alt="left-side-image">
                    </a>
                    <input 
                    {{$url_link ? 'disabled' : ''}}
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="box-content rounded border-2 border-gray-300">
                    <a id = "front-side"><img id="front-side-image" class="mx-auto" src="{{$editing ? $checkListVacuum->ext_splat_front : $hire->tanker->ext_splat_front}}" alt="front-side-image"></a>
                    <input 
                    {{$url_link ? 'disabled' : ''}}
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="box-content rounded border-2 border-gray-300">
                        <a id = "back-side"><img id="back-side-image" class="mx-auto" src="{{$editing ? $checkListVacuum->ext_splat_rear : $hire->tanker->ext_splat_rear}}" alt="back-side-image"></a>
                    <input 
                        {{$url_link ? 'disabled' : ''}}
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="box-content rounded border-2 border-gray-300">
                        <a id = "right-side"><img id="right-side-image" class="mx-auto" 
                            src="{{$editing ? $checkListVacuum->ext_splat_right : $hire->tanker->ext_splat_right}}"
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="box-content rounded border-2 border-gray-300">
                        <a id = "internal"><img id="internal-image" class="mx-auto" src="{{$editing ? $checkListVacuum->int_splat : $hire->tanker->int_splat}}" alt="internal-image"></a>
                    <input
                        {{$url_link ? 'disabled' : ''}}
