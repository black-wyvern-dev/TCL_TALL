        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            >
                ...
                <div class="mt-10">
                    ...
                    <a href="{{route('hires.edit', ['hire' => $hire])}}" id="abort_nr_btn" class="bg-orange-500 hover:bg-orange-700 text-white py-1 px-4 rounded-md float-right mr-5 cursor-pointer">
